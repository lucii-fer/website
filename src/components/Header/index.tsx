          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center px-4">
              <div className="flex-grow">
                ...
                >
                  <ul className="flex justify-center lg:ml-0 lg:flex lg:gap-x-8 xl:ml-0 xl:gap-x-12">
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                <Link
                  ...
                  target="__blank"
                  className={`rounded-lg px-6 py-3 text-base font-medium text-white duration-300 ease-in-out ml-4 ${
                    sticky
